...
> 부모는 통증을 느낀 부위를 직접 선택할 수 있으며, 해당 부위에 맞는 스트레칭 영상을 안내받을 수 있다.<br>
> 자녀는 부모의 통증 기록을 실시간으로 확인하며, 필요 시 적극적으로 대응할 수 있다.

**2. 약 복용 체크 기능**

> 복약 시간에 맞춰 부모에게 푸시 알림이 전송되며, 복용 완료 후 버튼을 눌러 기록할 수 있다.<br>
...
> 가족 구성원들의 걸음 수를 합산하여 하루 동안의 총 걸음 수를 시각화하며,<br>
